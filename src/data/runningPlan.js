export const RUNNING_PLAN = [
  ...
  // ─── RECOVERY & HYROX TRANSITION (Weeks 27–33) ────────────────────────────
  {
    week: 27,
    sessions: [
      { id: 'easy', type: 'recovery', label: 'Easy Jog', targetDistance: 5, targetPace: null, description: '5km easy jog — full recovery' },
      ...
      { id: 'long', type: 'recovery', label: 'Easy Jog', targetDistance: null, targetPace: null, description: '20min easy jog only — recovery' },
    ],
  },
  {
    week: 28,
    sessions: [
      { id: 'easy', type: 'recovery', label: 'Easy Jog', targetDistance: 8, targetPace: null, description: '8km easy — continue recovery' },
      { id: 'quality', type: 'recovery', label: 'Rest / Cross-train', targetDistance: null, targetPace: null, description: 'REST or light cross-train' },
      { id: 'tempo', type: 'recovery', label: 'Easy Run', targetDistance: 5, targetPace: null, description: '5km easy — keep moving' },
      { id: 'long', type: 'easy', label: 'Long Run', targetDistance: 13, targetPace: '5:50', description: '13km @ 5:50/km — gentle return' },
    ],
  },
  {
    week: 29,
    sessions: [
      { id: 'easy', type: 'easy', label: 'Easy Run', targetDistance: 13, targetPace: '5:50', description: '13km @ 5:50/km' },
      { id: 'quality', type: 'recovery', label: 'Rest / Cross-train', targetDistance: null, targetPace: null, description: 'REST or light cross-train' },
      { id: 'tempo', type: 'tempo', label: 'Tempo/MP', targetDistance: 6, targetPace: '5:45', description: '6km @ 5:45/km' },
      { id: 'long', type: 'long', label: 'Long Run', targetDistance: 10, targetPace: '5:30', description: '10km @ 5:30/km' },
    ],
  },
  {
    week: 30,
    sessions: [
      { id: 'easy', type: 'easy', label: 'Easy Run', targetDistance: 15, targetPace: '5:30', description: '15km @ 5:30/km' },
      { id: 'quality', type: 'quality', label: 'Hyrox Circuit', targetDistance: null, targetPace: null, description: 'Hyrox circuit x1 round (intro)' },
      { id: 'tempo', type: 'tempo', label: 'Tempo/MP', targetDistance: 6, targetPace: '5:10', description: '6km @ 5:10/km' },
      { id: 'long', type: 'long', label: 'Long Run', targetDistance: 12, targetPace: '5:20', description: '12km @ 5:20/km' },
    ],
  },
  {
    week: 31,
    sessions: [
      { id: 'easy', type: 'easy', label: 'Easy Run', targetDistance: 15, targetPace: '5:20', description: '15km @ 5:20/km' },
      { id: 'quality', type: 'quality', label: 'Hyrox Circuit', targetDistance: null, targetPace: null, description: 'Hyrox circuit x2 rounds' },
      { id: 'tempo', type: 'tempo', label: 'Tempo/MP', targetDistance: 6, targetPace: '5:00', description: '6km @ 5:00/km' },
      { id: 'long', type: 'long', label: 'Long Run', targetDistance: 13, targetPace: '5:10', description: '13km @ 5:10/km' },
    ],
  },
  {
    week: 32,
    sessions: [
      { id: 'easy', type: 'easy', label: 'Easy Run', targetDistance: 15, targetPace: '5:10', description: '15km @ 5:10/km' },
      { id: 'quality', type: 'quality', label: 'Hyrox Circuit', targetDistance: null, targetPace: null, description: 'Hyrox circuit x3 rounds' },
      { id: 'tempo', type: 'tempo', label: 'Tempo/MP', targetDistance: 7, targetPace: '4:55', description: '7km @ 4:55/km' },
      { id: 'long', type: 'long', label: 'Long Run + Hyrox Sim', targetDistance: 15, targetPace: null, description: '15km + Hyrox run simulation' },
    ],
  },
  {
    week: 33,
    sessions: [
      { id: 'easy', type: 'recovery', label: 'Easy Run', targetDistance: 8, targetPace: null, description: '8km easy — Hyrox race week' },
      { id: 'quality', type: 'quality', label: 'Hyrox Sharpener', targetDistance: null, targetPace: null, description: '2x Hyrox stations — stay sharp' },
      { id: 'tempo', type: 'recovery', label: 'Easy Jog', targetDistance: 3, targetPace: null, description: '3km easy — keep legs fresh' },
      { id: 'long', type: 'race', label: 'Hyrox December 2026', targetDistance: null, targetPace: null, description: 'HYROX — target sub-1:05:00' },
    ],
  },
]
